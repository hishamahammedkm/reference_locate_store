...
import 'package:find_best_deal/login/login_widget.dart';
import 'flutter_flow/flutter_flow_theme.dart';
...
class _MyAppState extends State<MyApp> {
  ...
  Stream<FindBestDealFirebaseUser> userStream;
  FindBestDealFirebaseUser initialUser;
  ...
  void initState() {
    super.initState();
    userStream = findBestDealFirebaseUserStream()
